        ...
        <div>
            ...
            <div className="w-full h-full m-auto">
                <div className="flex top-4 justify-center py-2">
                    <img src="../banners/secciones/Consultoria.png" className="h-[140px] object-cover sm:h-full bg-center" />
                </div>
                        ...
                        <div>
                            ...
                            <div>                                
                                <p className="mt-6 text-lg font-mont leading-8 text-gray-600 sm:text-center lg:px-24">
                                    ...
                                    Tenemos a tu disposición un equipo de profesionales altamente capacitados para alcanzar las expectativas y generar ese cambio que tanto necesitas.
                                </p>
